...
/** True when sign-in is active (email/password or federated auth). */
export const authConfigured =
  !authDisabled && (Boolean(grokClientId && grokClientSecret) || emailAndPasswordEnabled);
...
const baseURL = explicitBaseURL ?? {
  ...
  allowedHosts: [
    ...
    "[::1]",
    "*.netlify.app",
    "certificados-total.netlify.app",
    "breakpointcreativa.com",
  ],
  // `auto` → trust both http:// and https:// expansions of allowedHosts
  // (preview is https; local dev is http).
  protocol: "auto" as const,
  fallback: "https://certificados-total.netlify.app",
};
...
const trustedOrigins: string[] = [
  ...
  "https://certificados-total.netlify.app",
  "https://breakpointcreativa.com",
  "*.netlify.app",
  ...previewAllowedHosts,
